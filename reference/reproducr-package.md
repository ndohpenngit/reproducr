...
|----|----|
| Function | Purpose |
| [`audit_script()`](https://repro-stats.github.io/reproducr/reference/audit_script.md) | Parse a script and extract all `pkg::fn` calls |
| [`risk_score()`](https://repro-stats.github.io/reproducr/reference/risk_score.md) | Check calls against the breaking-changes database |
| [`certify()`](https://repro-stats.github.io/reproducr/reference/certify.md) | Hash and store analytical outputs as a baseline |
| [`check_drift()`](https://repro-stats.github.io/reproducr/reference/check_drift.md) | Compare current outputs against a stored baseline |
| [`list_certs()`](https://repro-stats.github.io/reproducr/reference/list_certs.md) | List all certifications in a `.reproducr` file |
| [`repro_report()`](https://repro-stats.github.io/reproducr/reference/repro_report.md) | Render a human-readable audit report |
| [`repro_badge()`](https://repro-stats.github.io/reproducr/reference/repro_badge.md) | Generate a reproducibility status badge |
