...
- [`audit_script()`](https://reproducr-dev.github.io/reproducr/reference/audit_script.md)
  [`print(`*`<audit_report>`*`)`](https://reproducr-dev.github.io/reproducr/reference/audit_script.md)
  [`summary(`*`<audit_report>`*`)`](https://reproducr-dev.github.io/reproducr/reference/audit_script.md)
...
- [`check_db_staleness()`](https://reproducr-dev.github.io/reproducr/reference/check_db_staleness.md)
  [`print(`*`<staleness_report>`*`)`](https://reproducr-dev.github.io/reproducr/reference/check_db_staleness.md)
...
- [`reproducr`](https://reproducr-dev.github.io/reproducr/reference/reproducr-package.md)
  [`reproducr-package`](https://reproducr-dev.github.io/reproducr/reference/reproducr-package.md)
...
- [`risk_score()`](https://reproducr-dev.github.io/reproducr/reference/risk_score.md)
  [`print(`*`<risk_report>`*`)`](https://reproducr-dev.github.io/reproducr/reference/risk_score.md)
  [`as.data.frame(`*`<risk_report>`*`)`](https://reproducr-dev.github.io/reproducr/reference/risk_score.md)
  [`` `[`( ``*`<risk_report>`*`)`](https://reproducr-dev.github.io/reproducr/reference/risk_score.md)
