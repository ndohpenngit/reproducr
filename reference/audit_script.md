...
print(report)
#> 
#> -- reproducr audit report [2026-06-06 19:49] --
#> 
#>   Files scanned:     1
#>   Packages found:    2
#>   Calls detected:    3
...
report$calls
#>                                 file line   pkg        fn pkg_version
#> 1 /tmp/RtmpKuNKvI/file196e30e5fa7f.R    2 dplyr    filter        <NA>
#> 2 /tmp/RtmpKuNKvI/file196e30e5fa7f.R    3 dplyr summarise        <NA>
#> 3 /tmp/RtmpKuNKvI/file196e30e5fa7f.R    4 stats     rnorm       4.6.0
```
