...
#> reproducr: certified 1 output(s) [2026-06-08] under tag 'v1'
certify(list(coefs = coef(model)), tag = "v2", file = cert_file)
#> reproducr: certified 1 output(s) [2026-06-08] under tag 'v2'

list_certs(file = cert_file)
#>   tag                timestamp r_version                      os n_outputs
#> 1  v1 2026-06-08T15:15:10+0000     4.6.0 Linux 6.17.0-1015-azure         1
#> 2  v2 2026-06-08T15:15:10+0000     4.6.0 Linux 6.17.0-1015-azure         1
#>   script
#> 1   <NA>
#> 2   <NA>
```
