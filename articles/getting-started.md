...
print(report)
#> 
#> -- reproducr audit report [2026-06-01 15:19] --
#> 
#>   Files scanned:     1
#>   Packages found:    3
#>   Calls detected:    5
...
#> 1 /tmp/Rtmpmlv6md/file1b1c7e31be7a.R    3 dplyr    filter        <NA>
#> 2 /tmp/Rtmpmlv6md/file1b1c7e31be7a.R    4 dplyr summarise        <NA>
#> 3 /tmp/Rtmpmlv6md/file1b1c7e31be7a.R    4 dplyr         n        <NA>
#> 4 /tmp/Rtmpmlv6md/file1b1c7e31be7a.R    6 stats     rnorm       4.6.0
#> 5 /tmp/Rtmpmlv6md/file1b1c7e31be7a.R    7  base      sort       4.6.0
```
...
#>   LOW:       1
#> 
#> [LOW]     base::sort  (line 7 in file1b1c7e31be7a.R)
#>          Check    : locale_check
...
#> 1 /tmp/Rtmpmlv6md/file1b1c7e31be7a.R    7 base::sort       4.6.0  low
#>          check
#> 1 locale_check
#>                                                                                                                                 description
...
#> 1 baseline-v1 2026-06-01T15:19:19+0000     4.6.0 Linux 6.17.0-1015-azure
#>   n_outputs                             script
#> 1         3 /tmp/Rtmpmlv6md/file1b1c7e31be7a.R
```
