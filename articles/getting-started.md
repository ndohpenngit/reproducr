...
print(report)
#> 
#> -- reproducr audit report [2026-06-03 14:04] --
#> 
#>   Files scanned:     1
#>   Packages found:    3
#>   Calls detected:    5
...
#> 1 /tmp/RtmpWQM9AV/file1c162d9a568a.R    3 dplyr    filter        <NA>
#> 2 /tmp/RtmpWQM9AV/file1c162d9a568a.R    4 dplyr summarise        <NA>
#> 3 /tmp/RtmpWQM9AV/file1c162d9a568a.R    4 dplyr         n        <NA>
#> 4 /tmp/RtmpWQM9AV/file1c162d9a568a.R    6 stats     rnorm       4.6.0
#> 5 /tmp/RtmpWQM9AV/file1c162d9a568a.R    7  base      sort       4.6.0
```
...
#>   LOW:       1
#> 
#> [LOW]     base::sort  (line 7 in file1c162d9a568a.R)
#>          Check    : locale_check
...
#> 1 /tmp/RtmpWQM9AV/file1c162d9a568a.R    7 base::sort       4.6.0  low
#>          check
#> 1 locale_check
#>                                                                                                                                 description
...
#> 1 baseline-v1 2026-06-03T14:04:38+0000     4.6.0 Linux 6.17.0-1015-azure
#>   n_outputs                             script
#> 1         3 /tmp/RtmpWQM9AV/file1c162d9a568a.R
```
