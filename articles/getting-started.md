...
#> 1 /tmp/RtmpYR18mf/file1a713c181f28.R    3 dplyr    filter        <NA>
#> 2 /tmp/RtmpYR18mf/file1a713c181f28.R    4 dplyr summarise        <NA>
#> 3 /tmp/RtmpYR18mf/file1a713c181f28.R    4 dplyr         n        <NA>
#> 4 /tmp/RtmpYR18mf/file1a713c181f28.R    6 stats     rnorm       4.6.0
#> 5 /tmp/RtmpYR18mf/file1a713c181f28.R    7  base      sort       4.6.0
```
...
#>   LOW:       1
#> 
#> [HIGH]    stats::rnorm  (line 6 in file1a713c181f28.R)
#>          Check    : changelog
...
#> 
#> [LOW]     base::sort  (line 7 in file1a713c181f28.R)
#>          Check    : locale_check
...
#> 1 /tmp/RtmpYR18mf/file1a713c181f28.R    6 stats::rnorm       4.6.0 high
#> 2 /tmp/RtmpYR18mf/file1a713c181f28.R    7   base::sort       4.6.0  low
#>          check
#> 1    changelog
#> 2 locale_check
#>                                                                                                                                 description
...
#> 1 baseline-v1 2026-05-31T00:35:18+0000     4.6.0 Linux 6.17.0-1015-azure
#>   n_outputs                             script
#> 1         3 /tmp/RtmpYR18mf/file1a713c181f28.R
```
...
#> reproducr: report written to '/tmp/RtmpYR18mf/file1a71779c060b.html'
```
