...
#> reproducr: certified 6 output(s) [2026-06-06] under tag 'baseline-v1'
```
...
#> reproducr: certified 1 output(s) [2026-06-06] under tag 'pre-peer-review'
...
#> reproducr: certified 1 output(s) [2026-06-06] under tag 'post-revision'
```
...
#> Warning: Tag 'baseline-v1' already exists in '/tmp/RtmpkfNdWz/file1af530d0b67'.
#> Overwriting.
#> reproducr: certified 1 output(s) [2026-06-06] under tag 'baseline-v1'
```
...
#> 1     baseline-v1 2026-06-06T19:50:05+0000     4.6.0 Linux 6.17.0-1015-azure
#> 2 pre-peer-review 2026-06-06T19:50:05+0000     4.6.0 Linux 6.17.0-1015-azure
#> 3   post-revision 2026-06-06T19:50:05+0000     4.6.0 Linux 6.17.0-1015-azure
#>   n_outputs script
#> 1         1   <NA>
#> 2         1   <NA>
#> 3         1   <NA>
...
#> reproducr: certified 3 output(s) [2026-06-06] under tag 'four-statuses'
...
#> reproducr: certified 1 output(s) [2026-06-06] under tag 'run-1'
certify(outputs = list(x = 1L), tag = "run-2", file = cert_file)
#> reproducr: certified 1 output(s) [2026-06-06] under tag 'run-2'
certify(outputs = list(x = 1L), tag = "run-3", file = cert_file)
#> reproducr: certified 1 output(s) [2026-06-06] under tag 'run-3'
