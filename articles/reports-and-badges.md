...
#> 
#> ### [LOW] base::sort
#> - File: file1c0839590655.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmplZ3LU1/file1c0839590655.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmplZ3LU1/file1c0831c96c31.md'
...
#> reproducr: report written to '/tmp/RtmplZ3LU1/file1c08470f8077.html'
...
#> reproducr: badge updated in '/tmp/RtmplZ3LU1/file1c0844a17870.md'
