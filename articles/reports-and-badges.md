...
#> 
#> ### [LOW] base::sort
#> - File: file1cd41daf9690.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmp0hHEx2/file1cd41daf9690.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmp0hHEx2/file1cd4705684ba.md'
...
#> reproducr: report written to '/tmp/Rtmp0hHEx2/file1cd47b67c37d.html'
...
#> reproducr: badge updated in '/tmp/Rtmp0hHEx2/file1cd4321b9718.md'
