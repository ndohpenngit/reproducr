...
#> 
#> ### [LOW] base::sort
#> - File: file1b707a7e8d23.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpE1ELkh/file1b707a7e8d23.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpE1ELkh/file1b703cbae80e.md'
...
#> reproducr: report written to '/tmp/RtmpE1ELkh/file1b7026307493.html'
...
#> reproducr: badge updated in '/tmp/RtmpE1ELkh/file1b7025a52c6.md'
