...
#> 
#> ### [LOW] base::sort
#> - File: file1b9b41e1fbf0.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmp3q5Kwc/file1b9b41e1fbf0.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1b9b41e1fbf0.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmp3q5Kwc/file1b9b4f62a563.md'
...
#> reproducr: report written to '/tmp/Rtmp3q5Kwc/file1b9b2fa5c366.html'
...
#> reproducr: badge updated in '/tmp/Rtmp3q5Kwc/file1b9b76e0abc3.md'
