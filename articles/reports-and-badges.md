...
#> 
#> ### [HIGH] stats::rnorm
#> - File: file1b61655be529.R, line 4
#> - Check: changelog
...
#> 
#> ### [LOW] base::sort
#> - File: file1b61655be529.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpbVmEzX/file1b61655be529.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpbVmEzX/file1b6118517abe.md'
...
#> reproducr: report written to '/tmp/RtmpbVmEzX/file1b617caaff63.html'
...
#> reproducr: badge updated in '/tmp/RtmpbVmEzX/file1b619e75a84.md'
