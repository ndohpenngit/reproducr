...
#> 
#> ### [LOW] base::sort
#> - File: file1c8b3d492f54.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpzfCDS3/file1c8b3d492f54.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c8b3d492f54.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpzfCDS3/file1c8b32261f4b.md'
...
#> reproducr: report written to '/tmp/RtmpzfCDS3/file1c8b2453e571.html'
...
#> reproducr: badge updated in '/tmp/RtmpzfCDS3/file1c8b4eb1ad9e.md'
