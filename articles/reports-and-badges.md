...
#> 
#> ### [LOW] base::sort
#> - File: file1c512ce32f1d.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpAwsSyp/file1c512ce32f1d.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpAwsSyp/file1c51762eea7e.md'
...
#> reproducr: report written to '/tmp/RtmpAwsSyp/file1c514cf4b638.html'
...
#> reproducr: badge updated in '/tmp/RtmpAwsSyp/file1c516f44c00f.md'
