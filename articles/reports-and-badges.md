...
#> 
#> ### [LOW] base::sort
#> - File: file1c38216333c5.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmpiz2cFz/file1c38216333c5.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmpiz2cFz/file1c383d982075.md'
...
#> reproducr: report written to '/tmp/Rtmpiz2cFz/file1c38911843d.html'
...
#> reproducr: badge updated in '/tmp/Rtmpiz2cFz/file1c3834e0efc6.md'
