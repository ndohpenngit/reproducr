...
#> 
#> ### [LOW] base::sort
#> - File: file1c3e44405594.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpH5D14F/file1c3e44405594.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpH5D14F/file1c3e42be0560.md'
...
#> reproducr: report written to '/tmp/RtmpH5D14F/file1c3e7f426b91.html'
...
#> reproducr: badge updated in '/tmp/RtmpH5D14F/file1c3e123195dc.md'
