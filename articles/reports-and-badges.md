...
#> 
#> ### [LOW] base::sort
#> - File: file1b5028f163a9.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmpc20EDd/file1b5028f163a9.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmpc20EDd/file1b50336a7dc6.md'
...
#> reproducr: report written to '/tmp/Rtmpc20EDd/file1b503d9633b9.html'
...
#> reproducr: badge updated in '/tmp/Rtmpc20EDd/file1b50e0cbbf1.md'
