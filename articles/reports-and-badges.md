...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmpod3hAk/file1bff2e56c73.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmpod3hAk/file1bffb0d40af.md'
...
#> reproducr: report written to '/tmp/Rtmpod3hAk/file1bff5194ec2c.html'
...
#> reproducr: badge updated in '/tmp/Rtmpod3hAk/file1bff6548e424.md'
