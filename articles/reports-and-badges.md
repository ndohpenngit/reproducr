...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmp4OGRnG/file1c769e6067.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c769e6067.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmp4OGRnG/file1c767c72930.md'
...
#> reproducr: report written to '/tmp/Rtmp4OGRnG/file1c764dbcda9b.html'
...
#> reproducr: badge updated in '/tmp/Rtmp4OGRnG/file1c7666e7bec2.md'
