...
#> 
#> ### [LOW] base::sort
#> - File: file1c4e2e87edb6.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpTZutFw/file1c4e2e87edb6.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpTZutFw/file1c4e7a72f1cd.md'
...
#> reproducr: report written to '/tmp/RtmpTZutFw/file1c4e7882e4a9.html'
...
#> reproducr: badge updated in '/tmp/RtmpTZutFw/file1c4e26f1be31.md'
