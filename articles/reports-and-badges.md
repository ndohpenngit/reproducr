...
#> 
#> ### [LOW] base::sort
#> - File: file1c933fae4854.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpPTdQiz/file1c933fae4854.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c933fae4854.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpPTdQiz/file1c9357f40e57.md'
...
#> reproducr: report written to '/tmp/RtmpPTdQiz/file1c9325b93f1f.html'
...
#> reproducr: badge updated in '/tmp/RtmpPTdQiz/file1c9361fa2328.md'
