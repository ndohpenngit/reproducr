...
#> 
#> ### [LOW] base::sort
#> - File: file1c775a961c60.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmpw61k24/file1c775a961c60.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c775a961c60.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmpw61k24/file1c774583b4d0.md'
...
#> reproducr: report written to '/tmp/Rtmpw61k24/file1c77269c4bce.html'
...
#> reproducr: badge updated in '/tmp/Rtmpw61k24/file1c7766c6e88f.md'
