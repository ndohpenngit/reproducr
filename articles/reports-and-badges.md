...
#> 
#> ### [LOW] base::sort
#> - File: file1b55162847ac.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpNOD5HB/file1b55162847ac.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpNOD5HB/file1b5557936d0.md'
...
#> reproducr: report written to '/tmp/RtmpNOD5HB/file1b5539a9fe4a.html'
...
#> reproducr: badge updated in '/tmp/RtmpNOD5HB/file1b552e87139c.md'
