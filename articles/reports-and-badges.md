...
#> 
#> ### [LOW] base::sort
#> - File: file1c0a4de23315.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpcD5wMB/file1c0a4de23315.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c0a4de23315.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpcD5wMB/file1c0a75786f73.md'
...
#> reproducr: report written to '/tmp/RtmpcD5wMB/file1c0a2981caf0.html'
...
#> reproducr: badge updated in '/tmp/RtmpcD5wMB/file1c0a6aa9114a.md'
