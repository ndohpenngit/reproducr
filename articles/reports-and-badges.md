...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpCZTj1a/file1c87fe16f4e.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c87fe16f4e.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpCZTj1a/file1c878f12914.md'
...
#> reproducr: report written to '/tmp/RtmpCZTj1a/file1c877787e2f5.html'
...
#> reproducr: badge updated in '/tmp/RtmpCZTj1a/file1c8725245518.md'
