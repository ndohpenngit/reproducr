...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmp992F63/file1c672c190a4.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmp992F63/file1c672d90206d.md'
...
#> reproducr: report written to '/tmp/Rtmp992F63/file1c676a538b65.html'
...
#> reproducr: badge updated in '/tmp/Rtmp992F63/file1c672ac19a8d.md'
