...
#> 
#> ### [LOW] base::sort
#> - File: file1c913b169688.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpKGjOwh/file1c913b169688.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
#> |---|---|---|---|---|---|
#> | 1 | base::sort | LOW | file1c913b169688.R:5 | locale_check | sort() output is locale-sensitive. Current locale: C.UTF-8. Results may differ on machines with different LC_COLLATE ... |
#> 
#> ## 5. Drift assessment
#> 
#> | Output | Status | Note |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpKGjOwh/file1c913038602a.md'
...
#> reproducr: report written to '/tmp/RtmpKGjOwh/file1c9149a91cc6.html'
...
#> reproducr: badge updated in '/tmp/RtmpKGjOwh/file1c912a292da5.md'
