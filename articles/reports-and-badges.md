...
#> 
#> ### [LOW] base::sort
#> - File: file1c35643acef0.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpfdqN85/file1c35643acef0.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpfdqN85/file1c356b728b71.md'
...
#> reproducr: report written to '/tmp/RtmpfdqN85/file1c3516eb141c.html'
...
#> reproducr: badge updated in '/tmp/RtmpfdqN85/file1c35454dd7e5.md'
