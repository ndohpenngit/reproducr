...
#> 
#> ### [LOW] base::sort
#> - File: file1c245003d033.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpQz7Tmr/file1c245003d033.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpQz7Tmr/file1c24e0d38b.md'
...
#> reproducr: report written to '/tmp/RtmpQz7Tmr/file1c243fb031e.html'
...
#> reproducr: badge updated in '/tmp/RtmpQz7Tmr/file1c2440f683a2.md'
