...
#> 
#> ### [HIGH] stats::rnorm
#> - File: file1b251784fd7d.R, line 4
#> - Check: changelog
...
#> 
#> ### [LOW] base::sort
#> - File: file1b251784fd7d.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/Rtmph4w6sW/file1b251784fd7d.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/Rtmph4w6sW/file1b2563450a08.md'
...
#> reproducr: report written to '/tmp/Rtmph4w6sW/file1b25252fa7ef.html'
...
#> reproducr: badge updated in '/tmp/Rtmph4w6sW/file1b2517bd7a84.md'
