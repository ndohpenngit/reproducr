...
#> 
#> ### [LOW] base::sort
#> - File: file1b68137ccdaf.R, line 5
#> - Check: locale_check
...
#> ## 2. Files audited
#> 
#> - /tmp/RtmpQJ1Ejm/file1b68137ccdaf.R
#> 
#> ## 3. Package inventory
#> 
#> | Package | Version |
...
repro_report(report, risks,
             ...
             style       = "minimal",
             output_file = md_file)
#> reproducr: report written to '/tmp/RtmpQJ1Ejm/file1b681f8776c5.md'
...
#> reproducr: report written to '/tmp/RtmpQJ1Ejm/file1b687fc0c660.html'
...
#> reproducr: badge updated in '/tmp/RtmpQJ1Ejm/file1b6872fe63a3.md'
