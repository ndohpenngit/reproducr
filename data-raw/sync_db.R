...
header <- c(
  ...
  "# Source of truth: https://github.com/reproducr-dev/reproducr-db",
  "#",
  sprintf("# Generated: %s", format(Sys.time(), "%Y-%m-%d %H:%M UTC", tz = "UTC")),
  sprintf("# Entries:   %d across %d pkg::fn keys",
